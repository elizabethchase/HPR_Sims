...
```{r binomial_perf}
binomial_results$analyze <- factor(binomial_results$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
binomial_pw_bias$analyze <- factor(binomial_pw_bias$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
binomial_pw_width$analyze <- factor(binomial_pw_width$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
binomial_pw_cover$analyze <- factor(binomial_pw_cover$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
...
mycurvefitsb <- get_f(mymodel, alpha = 0.05);
...
mycurvefitsb <- rbind(mycurvefitsb, data.frame("Median" = plogis(preds$fit), "Lower" = plogis(preds$fit - 1.96*preds$se.fit), "Upper" = plogis(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "bigstep", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "BB");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsb <- rbind(mycurvefitsb, data.frame("Median" = plogis(preds$fit), "Lower" = plogis(preds$fit - 1.96*preds$se.fit), "Upper" = plogis(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "bounce", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "BB");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsb <- rbind(mycurvefitsb, data.frame("Median" = plogis(preds$fit), "Lower" = plogis(preds$fit - 1.96*preds$se.fit), "Upper" = plogis(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "joinpoint", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "BB");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsb <- rbind(mycurvefitsb, data.frame("Median" = plogis(preds$fit), "Lower" = plogis(preds$fit - 1.96*preds$se.fit), "Upper" = plogis(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "impulse", "Mean" = NA))

mycurvefitsb$Model <- factor(mycurvefitsb$Model, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
...
```{r poisson_perf}
poisson_results$analyze <- factor(poisson_results$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
poisson_pw_bias$analyze <- factor(poisson_pw_bias$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
poisson_pw_width$analyze <- factor(poisson_pw_width$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
poisson_pw_cover$analyze <- factor(poisson_pw_cover$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
...
width_bin <- ggplot(data = filter(poisson_results, score=="width")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1, scales = "free_y") + theme_bw() + xlab("") + ylab("Credible Interval Width") + theme(strip.background = element_blank(), strip.text.x = element_blank(), text=element_text(size=12)) 
...
mycurvefitsp <- get_f(mymodel, alpha = 0.05);
...
mycurvefitsp <- rbind(mycurvefitsp, data.frame("Median" = exp(preds$fit), "Lower" = exp(preds$fit - 1.96*preds$se.fit), "Upper" = exp(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "bigstep", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "PO");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsp <- rbind(mycurvefitsp, data.frame("Median" = exp(preds$fit), "Lower" = exp(preds$fit - 1.96*preds$se.fit), "Upper" = exp(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "bounce", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "PO");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsp <- rbind(mycurvefitsp, data.frame("Median" = exp(preds$fit), "Lower" = exp(preds$fit - 1.96*preds$se.fit), "Upper" = exp(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "joinpoint", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)), family = "PO");
preds <- predict(mymodel, se.fit = TRUE);
mycurvefitsp <- rbind(mycurvefitsp, data.frame("Median" = exp(preds$fit), "Lower" = exp(preds$fit - 1.96*preds$se.fit), "Upper" = exp(preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "impulse", "Mean" = NA))

mycurvefitsp$Model <- factor(mycurvefitsp$Model, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
...
```{r gaussian_perf}
gaussian_pw_bias$analyze <- factor(gaussian_pw_bias$analyze, levels = c("Pspline", "GPR", "MedFilt", "TrendFilt", "HPR"), ordered = TRUE)
gaussian_pw_width$analyze <- factor(gaussian_pw_width$analyze, levels = c("Pspline", "GPR", "MedFilt", "TrendFilt", "HPR"), ordered = TRUE)
gaussian_pw_cover$analyze <- factor(gaussian_pw_cover$analyze, levels = c("Pspline", "GPR", "MedFilt", "TrendFilt", "HPR"), ordered = TRUE)
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)));
preds <- predict(mymodel, se.fit = TRUE);
mycurvefits <- rbind(mycurvefits, data.frame("Median" = (preds$fit), "Lower" = (preds$fit - 1.96*preds$se.fit), "Upper" = (preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "bounce", "Mean" = NA))
...
mymodel <- gamlss(y ~ pb(X[,1], control = pb.control(order = 0)));
preds <- predict(mymodel, se.fit = TRUE);
mycurvefits <- rbind(mycurvefits, data.frame("Median" = (preds$fit), "Lower" = (preds$fit - 1.96*preds$se.fit), "Upper" = (preds$fit + 1.96*preds$se.fit), "x" = X[,1], "Model" = "Pspline", "simulate" = "impulse", "Mean" = NA))

mycurvefits$Model <- factor(mycurvefits$Model, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
...
mymodel <- hpr(y = y, X = X, family = "gaussian");
mycurvefitsm <- get_f(mymodel, alpha = 0.05);
...
beta_agg$analyze <- factor(beta_agg$analyze, levels = c("Pspline", "GPR", "HPR"), ordered = TRUE)
