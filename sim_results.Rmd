...
```{r binomial_perf}
mad_bin <- ggplot(data = filter(binomial_results, score=="mad")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference") + theme(strip.background = element_blank(), strip.text.x = element_blank())
...
cover_bin <- ggplot(data = filter(binomial_results, score=="cover")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank())
...
```{r poisson_perf}
mad_bin <- ggplot(data = filter(poisson_results, score=="mad")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference") + theme(strip.background = element_blank(), strip.text.x = element_blank())

width_bin <- ggplot(data = filter(poisson_results, score=="width")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width") + theme(strip.background = element_blank(), strip.text.x = element_blank()) + coord_cartesian(ylim = c(0, 8))

cover_bin <- ggplot(data = filter(poisson_results, score=="cover")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank())
...
```{r gaussian_perf}
mad_bin <- ggplot(data = filter(gaussian_results, score=="mad")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90))
...
cover_bin <- ggplot(data = filter(gaussian_results, score=="cover")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90))
...
```{r monotonic}
mad_bin <- ggplot(data = filter(monotonic_results, score=="mad")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90))
...
cover_bin <- ggplot(data = filter(monotonic_results, score=="cover")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90))
...
## PLM Results
```{r plm}
mad_bin <- ggplot(data = filter(plm_results, score=="mad_adj")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference") + theme(axis.text.x = element_text(angle = 90))
...
cover_bin <- ggplot(data = filter(plm_results, score=="cover_adj")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90))
...
beta_cover <- ggplot(data = filter(beta_set, grepl("cover", score))) + geom_boxplot(aes(x = analyze, y = score.metric, color = Beta)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90), legend.position = "bottom")
...
mad_obs <- ggplot(data = filter(gaussian_aug_results, score=="mad_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Observed Points") + theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

mad_aug <- ggplot(data = filter(gaussian_aug_results, score=="mad_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_obs <- ggplot(data = filter(gaussian_aug_results, score=="width_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_aug <- ggplot(data = filter(gaussian_aug_results, score=="width_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_obs <- ggplot(data = filter(gaussian_aug_results, score=="cover_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_aug <- ggplot(data = filter(gaussian_aug_results, score=="cover_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("Augmented Grid Density") + ylab("Credible Interval Coverage \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90, hjust=1))

gaus_aug_perf <- plot_grid(mad_obs, mad_aug, width_obs, width_aug, cover_obs, cover_aug, nrow = 6)
...
mad_obs <- ggplot(data = filter(binomial_aug_results, score=="mad_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Observed Points") + theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

mad_aug <- ggplot(data = filter(binomial_aug_results, score=="mad_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_obs <- ggplot(data = filter(binomial_aug_results, score=="width_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_aug <- ggplot(data = filter(binomial_aug_results, score=="width_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_obs <- ggplot(data = filter(binomial_aug_results, score=="cover_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_aug <- ggplot(data = filter(binomial_aug_results, score=="cover_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("Augmented Grid Density") + ylab("Credible Interval Coverage \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90, hjust=1))

bin_aug_perf <- plot_grid(mad_obs, mad_aug, width_obs, width_aug, cover_obs, cover_aug, nrow = 6)
...
mad_obs <- ggplot(data = filter(poisson_aug_results, score=="mad_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Observed Points") + theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

mad_aug <- ggplot(data = filter(poisson_aug_results, score=="mad_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Mean Absolute Difference \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_obs <- ggplot(data = filter(poisson_aug_results, score=="width_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

width_aug <- ggplot(data = filter(poisson_aug_results, score=="width_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Width \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_obs <- ggplot(data = filter(poisson_aug_results, score=="cover_obs")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("") + ylab("Credible Interval Coverage \nat Observed Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank())

cover_aug <- ggplot(data = filter(poisson_aug_results, score=="cover_aug")) + geom_boxplot(aes(x = analyze, y = score.metric)) + facet_wrap(~ simulate, nrow = 1) + theme_bw() + xlab("Augmented Grid Density") + ylab("Credible Interval Coverage \nat Augmented Points") + theme(strip.background = element_blank(), strip.text.x = element_blank(), axis.text.x = element_text(angle = 90, hjust=1))

pois_aug_perf <- plot_grid(mad_obs, mad_aug, width_obs, width_aug, cover_obs, cover_aug, nrow = 6)
